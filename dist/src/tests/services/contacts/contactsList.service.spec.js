...
describe("List contacts", () => {
    ...
    test("User can list your contacts", () => __awaiter(void 0, void 0, void 0, function* () {
        const user = {
        ...
        const contact = yield (0, createContacts_service_1.default)(newUser.id, {
            full_name: "Jest test",
            email: "test@email.com",
            phone: "12345678",
        });
        const contacts = yield (0, listUsers_service_1.default)(newUser.id);
