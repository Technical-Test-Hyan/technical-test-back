...
describe("Create an user returning a hashed password", () => {
    ...
    test("Should returning a hashed password", () => __awaiter(void 0, void 0, void 0, function* () {
        const user = {
...
describe("Testing if when creating a user it returns a list of contacts", () => {
    ...
    test("Should returning a list of contacts", () => __awaiter(void 0, void 0, void 0, function* () {
        const user = {
            email: "hyan@email.com",
            password: "1234Lopes!",
            full_name: "Hyan Lopes de Andrade",
